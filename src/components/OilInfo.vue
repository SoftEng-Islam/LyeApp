	...
	ul(class="bg-[var(--dark400)] mt-4 p-2 rounded-md h-full flex flex-col")
		...
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[0] }">!</button>
				| Hardness#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Hardness}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[1] }">!</button>
				| Cleansing#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Cleansing}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[2] }">!</button>
				| Condition#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Condition}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[3] }">!</button>
				| Bubbly#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Bubbly}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[4] }">!</button>
				| Creamy#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Creamy}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[5] }">!</button>
				| Iodine#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Iodine}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryRanges[6] }">!</button>
		...
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[0] }">!</button>
				| Lauric#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Lauric}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[1] }">!</button>
				| Myristic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Myristic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[2] }">!</button>
				| Palmitic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Palmitic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[3] }">!</button>
				| Stearic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Stearic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[4] }">!</button>
				| Ricinoleic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Ricinoleic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[5] }">!</button>
				| Oleic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Oleic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[6] }">!</button>
				| Linoleic#[span(class="text-yellow-500") :]
			span(class="float-right text-yellow-500") {{OilProperties.Linoleic}}
		li
			span(class="float-left text-white flex items-center")
				<button class="w-4 h-4 rounded-full flex items-center justify-center bg-yellow-600 text-sm mr-2 text-black" v-tippy="{ content: aryFADetail[7] }">!</button>
