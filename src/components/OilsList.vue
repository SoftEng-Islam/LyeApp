...
<template lang="pug">
//- Oils list Section
div(class="lyeWidget p-2 flex flex-col gap-2 min-h-[200px] max-h-[50%] rounded-md overflow-hidden bg-[var(--dark400)]" id="notes")
	...
	div(class="w-full h-full flex flex-col gap-2 items-center")
		...
		//- Oils
		div(class="OilsList w-full h-full flex items-start justify-center")
			PerfectScrollbar(class="h-full w-full bg-[var(--dark300)] rounded-lg border-4 border-[var(--dark300)]")
