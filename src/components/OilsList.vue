...
<template lang="pug">
//- Oils list Section
div(class="relative z-10 h-full w-72 p-3 overflow-hidden bg-[var(--dark400)] border-r-2 border-solid border-[var(--favColor)]" id="notes")
	div(class="w-full h-full flex flex-col items-center")
		//- Search
		div(class="relative w-full p-2 m-2 mb-4 flex items-center justify-center")
		...
		//- Oils
		div(class="OilsList pt-4 w-full h-full flex items-start justify-center")
			PerfectScrollbar(class="h-[83%] w-full bg-[var(--dark300)] rounded-lg border-4 border-[var(--dark300)]")
